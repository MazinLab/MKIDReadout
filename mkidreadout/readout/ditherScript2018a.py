...
#Make cfg file for quick stacker

#SET THESE EACH TIME A NEW FLAT OR DARK IS MADE
darkSpanImg = [1527738570,1527738600]
darkSpanFlat = [1527738570,1527738600]
flatSpan = [1527738570,1527738600]
darkBool = 'True'
flatBool = 'False'
hpmBool= 'True'

#SET THESE EACH NEW DAY
date = 20180530

#SET THESE AT THE BEGINNING OF EACH RUN
