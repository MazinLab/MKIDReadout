...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_3.setGeometry(QtCore.QRect(710, 850, 62, 17))
        ...
        self.jumptoresbyid = QtGui.QPushButton(self.centralwidget)
        self.jumptoresbyid.setGeometry(QtCore.QRect(690, 736, 111, 41))
        self.jumptoresbyid.setObjectName(_fromUtf8("jumptoresbyid"))
        self.jumptoid = QtGui.QSpinBox(self.centralwidget)
        self.jumptoid.setGeometry(QtCore.QRect(810, 740, 57, 31))
        self.jumptoid.setMaximum(999999)
        self.jumptoid.setObjectName(_fromUtf8("jumptoid"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.jumptoresbyid.setText(QtGui.QApplication.translate("MainWindow", "Jump to Res ID", None, QtGui.QApplication.UnicodeUTF8))
...
class Ui_MainWindow_Small(object):
    def setupUi(self, MainWindow):
        ...
        self.jumptoresbyid.setGeometry(QtCore.QRect(690, 736, 111, 41))
        self.jumptoresbyid.setObjectName(_fromUtf8("jumptoresbyid"))
        self.gridLayout.addWidget(self.jumptoresbyid, 4, 2, 1, 1)
        self.jumptoid = QtGui.QSpinBox(self.centralwidget)
        self.jumptoid.setGeometry(QtCore.QRect(810, 740, 57, 31))
        self.jumptoid.setMaximum(999999)
        self.jumptoid.setObjectName(_fromUtf8("jumptoid"))
        self.gridLayout.addWidget(self.jumptoid, 4, 1, 1, 1)
