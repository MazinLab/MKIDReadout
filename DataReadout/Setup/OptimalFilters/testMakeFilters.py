...
if True:
    ...
    #rawData*=2
    #rawData=np.load('/mnt/data0/Darkness/20160723/snap_117_ch657_20161018-202109.npz')
    #rawData=np.load('/mnt/data0/Darkness/20160723/snap_117_ch2_20161018-181027.npz')
    #rawData=np.load('/mnt/data0/Darkness/20160723/snap_117_ch74_20161018-182449.npz')   #good file can see pulses
    #rawData=np.load('/mnt/data0/Darkness/20160723/snap_117_ch2_20161018-181027.npz')    #data looks fine but no pulses
    #rawData=np.load('/mnt/data0/Darkness/20160723/snap_117_ch3_20161018-181039.npz')    #good file can see pulses
    #rawData=np.load('/mnt/data0/Darkness/20160723/snap_117_ch6_20161018-181115.npz')    #good file can see pulses
