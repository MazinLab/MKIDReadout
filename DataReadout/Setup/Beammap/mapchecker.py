...
#Beammap is read in where each line is a pixel and the columns, left to right, are
#ResID, flag, x-coordinate, y-coordinate
beammap=np.loadtxt(r"beammapTestData/test/finalMap_20180605.txt")

resIDs_and_freqs=glob.glob(r"beammapTestData/test/ps_*")

FreqSweepFiles = glob.glob("beammapTestData/test/ps_*")
