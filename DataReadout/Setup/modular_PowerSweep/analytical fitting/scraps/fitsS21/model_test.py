...
f0 = 4.500e9
freqs = np.linspace(4.49995e9,4.50005e9,10000)
# df = 0.007
                            ...
                            for pgain0 in pgain0s:
                                for pgain1 in pgain1s:
                                    for offset in offsets:
                                        ...
                                        ax.plot(y, np.log10(modelI**2 + modelQ**2), label=[qc,qi])#alabels[ia]
...
2.83526508e-06   4.54800961e+09   3.52091289e+04   4.29318778e+05
