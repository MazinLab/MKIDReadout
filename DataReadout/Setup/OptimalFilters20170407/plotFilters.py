...
class Window(QtGui.QDialog):
    ...
    def loadData(self):
        ...
        self.f_template_coef = os.path.join(str(self.directory),'template_coefficients_20170407.txt')
        self.f_filter_coef= os.path.join(str(self.directory),'filter_coefficients_20170407_new_normd.txt')
        self.f_noise= os.path.join(str(self.directory),'noise_data_20170407.txt')
        self.f_rough_templates= os.path.join(str(self.directory),'rough_templates_20170407.txt')
        self.f_type= os.path.join(str(self.directory),'filter_type_20170407.txt')
        self.f_list= os.path.join(str(self.directory),'file_list_20170407.txt')
        self.f_log= os.path.join(str(self.directory),'log_file_20170407.txt')
        self.f_filters_fourier=os.path.join(str(self.directory),'filters_fourier_20170407.txt')

        self.template_coefficients = np.loadtxt(self.f_template_coef)
        self.filter_coefficients=np.transpose(np.loadtxt(self.f_filter_coef))
